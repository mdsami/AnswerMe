			        ...
			        <div class="col-md-8 col-md-offset-2">
			            <div class="panel panel-default">
			                ...
			                <div class="panel-body">
			                   ...
			                   <form class="form-horizontal" role="form" method="POST" action="/adminpanel/UsersMangemant/updateUser/{{$user_info->id}}" enctype="multipart/form-data">
			                        {{ csrf_field() }}
			                        ...
			                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                                <input id="name" type="text" class="form-control" name="name" value="{{$user_info->name}}" required autofocus>
			                        ...
			                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                                <input id="phone" type="text" class="form-control" name="phone" value="{{$user_info->phone}}" required autofocus>
			                        ...
			                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                                <input id="email" type="email" class="form-control" name="email" value="{{$user_info->email}}" required autofocus>
			                        ...
			                        <div class="form-group{{ $errors->has('password_confir') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                                <input id="password_confir" type="password" class="form-control" name="password_confir" >
			                        ...
			                        <div class="form-group{{ $errors->has('is_verified') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                               		<select class="form-control" name="is_verified" >
			                               			<option>...</option>
			                               			<option value="1" @if($user_info->is_verified ==1) selected @endif >تم التحقيق</option>
			                               			<option value="0" @if($user_info->is_verified ==0) selected @endif>لم يتم التحقيق</option>
			                               		</select>
			                        ...
			                        <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                               		<select class="form-control" name="is_active">
			                               			<option>...</option>
			                               			<option value="1" @if($user_info->is_active ==1) selected @endif>مفعل</option>
			                               			<option value="0" @if($user_info->is_active ==0) selected @endif>معطل</option>
			                               		</select>
			                        ...
			                        <div class="form-group{{ $errors->has('ghostName') ? ' has-error' : '' }}">
			                            ...
			                            <div class="col-md-8">
			                                <input id="ghostName" type="text" value="{{$user_info->ghostName}}" class="form-control" name="ghostName" required>
			                            ...
			                            <div class="col-md-8">
			                                ...
			                                <div style="width:50px; height:50px; float:left; margin-left:15px; margin-bottom: 40px;">
			                                	<input  id="GhostImage"
			                                	    	...
			                                	    	@if($image->id == $user_info->ghost_images_id) checked @endif>
